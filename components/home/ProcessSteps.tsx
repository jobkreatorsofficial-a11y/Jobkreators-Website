...
export default function ProcessSteps() {
  ...
  // Step fade-up stagger (parent → children variants), gated on motion safety.
  const stepVariants = motionSafe
    ? {
      ...
      <Container>
        ...
        >
          {/* Connecting line — horizontal on desktop, vertical on mobile. The base
              hairline sits behind; the accent overlay draws in on scroll. */}
            ...
            {PROCESS.map((step) => (
              ...
              >
                ...
                <div className="md:mt-6">
                  <div className="font-display text-display-xl font-bold leading-none text-accent">
                    {step.step}
                  </div>
