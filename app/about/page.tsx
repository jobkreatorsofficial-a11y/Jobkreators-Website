  ...
  return (
    <>
      ...
      <main className="pt-16">
        {/* Hero */}
        <section className="py-16 md:py-28 bg-bg relative overflow-hidden">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-accent/5 rounded-full blur-3xl" />
          <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center relative z-10">
            <p className="text-sm font-medium text-accent tracking-widest uppercase mb-4">Our Story</p>
            <h1 className="text-3xl sm:text-5xl md:text-6xl font-bold font-display text-text mb-6 leading-tight">
        ...
        <section className="py-20 bg-bg">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
              {STATS.map((stat) => (
                <div key={stat.label} className="text-center p-6 rounded-2xl bg-surface-2">
